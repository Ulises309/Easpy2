...
{
    /// <summary>
    /// Summary description for cls_Base_de_datos
    /// </summary>
    public class Cls_BD
    {
        public Cls_BD()
        ...
        public class Cls_Coneccion : IDisposable
        {
            ...
            /// <summary>
            /// Crea Parametro de entrada de tipo Null
            /// </summary>
            /// <param name="strParameterName"></param>
            /// <param name="nParameter"></param>
            public void CreateParameter(string strParameterName, DBNull nParameter)
            {
                command.Parameters.AddWithValue(strParameterName, nParameter);
            }
